...
Gem::Specification.new do |spec|
  ...
  spec.metadata["source_code_uri"] = "https://github.com/RocketApex/passive_model/tree/main"
  spec.metadata["changelog_uri"] = "https://github.com/RocketApex/passive_model/blob/main/CHANGELOG.md"

  spec.files = Dir.chdir(File.expand_path(__dir__)) do
    Dir["{lib}/**/*", "CHANGELOG.md", "MIT-LICENSE", "Rakefile", "README.md"]
  end
